...
### 31.5.4
* Fix formatting on placeholder replacements
* Fix formatting appearance in settings page for "Supported Placeholders"
### 31.5.3
...
### 31.3.0
*  Make all placeholders be replaced if there are multiple copies (previously would only replace the first occurrance)
### 31.2.3
* Make all placeholders case insensitive
### 31.2.2
* Add requirements placeholder to "initial message to restricted users"
### 31.2.1
...
* Change {{commandsWithOr}} and {{commandsWithAnd}} placeholders back to just {{commands}}
### 31.0.0
...
* Make update notifications work properly
### 30.1.0
...
### 29.1.1
* Change leaderboard wiki page capacity to 10,000 entries (will only update once a point is awarded to someone)
### 29.1.0
...
### 28.0.1
* Remove inaccurate statement from v28.0.0
### 28.0.0
...
### 14.0.1
* Add `{{permalink}}` to Supported Placeholders list on Subsequent Post Restriction Message
### 14.0.0
